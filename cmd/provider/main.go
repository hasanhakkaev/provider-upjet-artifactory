...
import (
	...
	"github.com/upbound/provider-artifactory/apis"
	"github.com/upbound/provider-artifactory/apis/v1alpha1"
	"github.com/upbound/provider-artifactory/config"
	"github.com/upbound/provider-artifactory/internal/clients"
	"github.com/upbound/provider-artifactory/internal/controller"
	"github.com/upbound/provider-artifactory/internal/features"
)
...
func main() {
	...
	log := logging.NewLogrLogger(zl.WithName("provider-artifactory"))
	if *debug {
	...
	mgr, err := ctrl.NewManager(cfg, ctrl.Options{
		...
		LeaderElectionID: "crossplane-leader-election-provider-artifactory",
		Cache: cache.Options{
