...
// TerraformModuleRepository is the Schema for the TerraformModuleRepositorys API.
...
func init() {
	SchemeBuilder.Register(&TerraformModuleRepository{}, &TerraformModuleRepositoryList{})
}
