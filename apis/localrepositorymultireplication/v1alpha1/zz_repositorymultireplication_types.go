...
type ReplicationInitParameters struct {
	...
	// The username on the remote Artifactory instance.
...
type RepositoryMultiReplicationInitParameters struct {
...
type RepositoryMultiReplicationObservation struct {
...
type RepositoryMultiReplicationParameters struct {
...
// RepositoryMultiReplicationSpec defines the desired state of RepositoryMultiReplication
type RepositoryMultiReplicationSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     RepositoryMultiReplicationParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider RepositoryMultiReplicationInitParameters `json:"initProvider,omitempty"`
}

// RepositoryMultiReplicationStatus defines the observed state of RepositoryMultiReplication.
type RepositoryMultiReplicationStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        RepositoryMultiReplicationObservation `json:"atProvider,omitempty"`
}
...
// RepositoryMultiReplication is the Schema for the RepositoryMultiReplications API.
...
type RepositoryMultiReplication struct {
	...
	Spec   RepositoryMultiReplicationSpec   `json:"spec"`
	Status RepositoryMultiReplicationStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// RepositoryMultiReplicationList contains a list of RepositoryMultiReplications
type RepositoryMultiReplicationList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []RepositoryMultiReplication `json:"items"`
}

// Repository type metadata.
var (
	RepositoryMultiReplication_Kind             = "RepositoryMultiReplication"
	RepositoryMultiReplication_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: RepositoryMultiReplication_Kind}.String()
	RepositoryMultiReplication_KindAPIVersion   = RepositoryMultiReplication_Kind + "." + CRDGroupVersion.String()
	RepositoryMultiReplication_GroupVersionKind = CRDGroupVersion.WithKind(RepositoryMultiReplication_Kind)
)

func init() {
	SchemeBuilder.Register(&RepositoryMultiReplication{}, &RepositoryMultiReplicationList{})
}
