...
type PropertyCustomWebhookInitParameters struct {
...
type PropertyCustomWebhookObservation struct {
...
type PropertyCustomWebhookParameters struct {
...
// PropertyCustomWebhookSpec defines the desired state of PropertyCustomWebhook
type PropertyCustomWebhookSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     PropertyCustomWebhookParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider PropertyCustomWebhookInitParameters `json:"initProvider,omitempty"`
}

// PropertyCustomWebhookStatus defines the observed state of PropertyCustomWebhook.
type PropertyCustomWebhookStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        PropertyCustomWebhookObservation `json:"atProvider,omitempty"`
}
...
// PropertyCustomWebhook is the Schema for the PropertyCustomWebhooks API.
...
type PropertyCustomWebhook struct {
	...
	Spec   PropertyCustomWebhookSpec   `json:"spec"`
	Status PropertyCustomWebhookStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// PropertyCustomWebhookList contains a list of PropertyCustomWebhooks
type PropertyCustomWebhookList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []PropertyCustomWebhook `json:"items"`
}

// Repository type metadata.
var (
	PropertyCustomWebhook_Kind             = "PropertyCustomWebhook"
	PropertyCustomWebhook_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: PropertyCustomWebhook_Kind}.String()
	PropertyCustomWebhook_KindAPIVersion   = PropertyCustomWebhook_Kind + "." + CRDGroupVersion.String()
	PropertyCustomWebhook_GroupVersionKind = CRDGroupVersion.WithKind(PropertyCustomWebhook_Kind)
)

func init() {
	SchemeBuilder.Register(&PropertyCustomWebhook{}, &PropertyCustomWebhookList{})
}
