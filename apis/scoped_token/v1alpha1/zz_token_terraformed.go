...
func (mg *Token) GetTerraformResourceType() string {
	return "artifactory_scoped_token"
}

// GetConnectionDetailsMapping for this Token
func (tr *Token) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"access_token": "status.atProvider.accessToken", "reference_token": "status.atProvider.referenceToken", "refresh_token": "status.atProvider.refreshToken"}
}
