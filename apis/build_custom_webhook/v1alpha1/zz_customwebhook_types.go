...
type CriteriaInitParameters struct {
	...
	AnyBuild *bool `json:"anyBuild,omitempty" tf:"any_build,omitempty"`
	...
	// +listType=set
	SelectedBuilds []*string `json:"selectedBuilds,omitempty" tf:"selected_builds,omitempty"`
}
...
type CriteriaParameters struct {
	...
	AnyBuild *bool `json:"anyBuild" tf:"any_build,omitempty"`
	...
	// +kubebuilder:validation:Optional
	// +listType=set
	SelectedBuilds []*string `json:"selectedBuilds" tf:"selected_builds,omitempty"`
}
...
type CustomWebhookInitParameters struct {
	...
	// Allow values: uploaded, deleted, promoted
	// +listType=set
