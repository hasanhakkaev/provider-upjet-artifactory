...
func (mg *TerraformModuleRepository) GetTerraformResourceType() string {
	return "artifactory_federated_terraform_module_repository"
}
...
// LateInitialize this TerraformModuleRepository using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *TerraformModuleRepository) LateInitialize(attrs []byte) (bool, error) {
	params := &TerraformModuleRepositoryParameters{}
