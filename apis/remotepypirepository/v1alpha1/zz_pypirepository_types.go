...
type PypiRepositoryInitParameters struct {
	...
	// To configure the remote repo to proxy public external PyPI repository, or a PyPI repository hosted on another Artifactory server. See JFrog Pypi documentation here for the usage details. Default value is https://pypi.org.
...
// PypiRepository is the Schema for the PypiRepositorys API.
