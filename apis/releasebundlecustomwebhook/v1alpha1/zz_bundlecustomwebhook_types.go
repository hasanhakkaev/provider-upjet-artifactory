...
type BundleCustomWebhookInitParameters struct {
...
type BundleCustomWebhookObservation struct {
...
type BundleCustomWebhookParameters struct {
...
// BundleCustomWebhookSpec defines the desired state of BundleCustomWebhook
type BundleCustomWebhookSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     BundleCustomWebhookParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider BundleCustomWebhookInitParameters `json:"initProvider,omitempty"`
}

// BundleCustomWebhookStatus defines the observed state of BundleCustomWebhook.
type BundleCustomWebhookStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        BundleCustomWebhookObservation `json:"atProvider,omitempty"`
}
...
// BundleCustomWebhook is the Schema for the BundleCustomWebhooks API. <no value>
...
type BundleCustomWebhook struct {
	...
	Spec   BundleCustomWebhookSpec   `json:"spec"`
	Status BundleCustomWebhookStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// BundleCustomWebhookList contains a list of BundleCustomWebhooks
type BundleCustomWebhookList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []BundleCustomWebhook `json:"items"`
}

// Repository type metadata.
var (
	BundleCustomWebhook_Kind             = "BundleCustomWebhook"
	BundleCustomWebhook_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: BundleCustomWebhook_Kind}.String()
	BundleCustomWebhook_KindAPIVersion   = BundleCustomWebhook_Kind + "." + CRDGroupVersion.String()
	BundleCustomWebhook_GroupVersionKind = CRDGroupVersion.WithKind(BundleCustomWebhook_Kind)
)

func init() {
	SchemeBuilder.Register(&BundleCustomWebhook{}, &BundleCustomWebhookList{})
}
