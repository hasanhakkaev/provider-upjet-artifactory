...
type TerraformProviderRepositoryInitParameters struct {
	...
	// Default is false. This attribute is added to match Terrform logic, so all the resources, created by the provider, must be removed on cleanup. Artifactory's behavior for the federated repositories is different, all the federated repositories stay after the user deletes the initial federated repository. Caution: if set to true all the repositories in the federation will be deleted, including repositories on other Artifactory instances in the "Circle of trust". This operation can not be reversed. Caution: it will delete all the repositories in the federation on other Artifactory instances.
...
// TerraformProviderRepository is the Schema for the TerraformProviderRepositorys API.
...
func init() {
	SchemeBuilder.Register(&TerraformProviderRepository{}, &TerraformProviderRepositoryList{})
}
