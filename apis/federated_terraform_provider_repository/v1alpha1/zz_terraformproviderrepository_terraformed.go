...
func (mg *TerraformProviderRepository) GetTerraformResourceType() string {
	return "artifactory_federated_terraform_provider_repository"
}
...
// LateInitialize this TerraformProviderRepository using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *TerraformProviderRepository) LateInitialize(attrs []byte) (bool, error) {
	params := &TerraformProviderRepositoryParameters{}
