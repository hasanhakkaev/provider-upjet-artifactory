...
type ReleaseBundleCustomWebhookInitParameters struct {
...
type ReleaseBundleCustomWebhookObservation struct {
...
type ReleaseBundleCustomWebhookParameters struct {
...
// ReleaseBundleCustomWebhookSpec defines the desired state of ReleaseBundleCustomWebhook
type ReleaseBundleCustomWebhookSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     ReleaseBundleCustomWebhookParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider ReleaseBundleCustomWebhookInitParameters `json:"initProvider,omitempty"`
}

// ReleaseBundleCustomWebhookStatus defines the observed state of ReleaseBundleCustomWebhook.
type ReleaseBundleCustomWebhookStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        ReleaseBundleCustomWebhookObservation `json:"atProvider,omitempty"`
}
...
// ReleaseBundleCustomWebhook is the Schema for the ReleaseBundleCustomWebhooks API.
...
type ReleaseBundleCustomWebhook struct {
	...
	Spec   ReleaseBundleCustomWebhookSpec   `json:"spec"`
	Status ReleaseBundleCustomWebhookStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// ReleaseBundleCustomWebhookList contains a list of ReleaseBundleCustomWebhooks
type ReleaseBundleCustomWebhookList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []ReleaseBundleCustomWebhook `json:"items"`
}

// Repository type metadata.
var (
	ReleaseBundleCustomWebhook_Kind             = "ReleaseBundleCustomWebhook"
	ReleaseBundleCustomWebhook_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: ReleaseBundleCustomWebhook_Kind}.String()
	ReleaseBundleCustomWebhook_KindAPIVersion   = ReleaseBundleCustomWebhook_Kind + "." + CRDGroupVersion.String()
	ReleaseBundleCustomWebhook_GroupVersionKind = CRDGroupVersion.WithKind(ReleaseBundleCustomWebhook_Kind)
)

func init() {
	SchemeBuilder.Register(&ReleaseBundleCustomWebhook{}, &ReleaseBundleCustomWebhookList{})
}
